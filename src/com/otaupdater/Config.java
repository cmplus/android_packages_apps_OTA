...
public class Config {
    ...
    public static final String DONATE_URL = "http://www.sspencer10.com/android/devices";
    ...
    public static final String OTA_MOTOOMAP_REBOOT = "otaupdater.motoomap.reboot";
